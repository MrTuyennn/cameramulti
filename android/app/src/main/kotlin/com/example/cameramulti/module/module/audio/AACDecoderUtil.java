package com.example.cameramulti.module.module.audio;
...
public class AACDecoderUtil {
    ...
    public void decode(byte[] buf, int offset, int length) {
        ...
        try {
            ...
            System.out.printf("[TUTK]start_ipcam_audio decode stream outputBufferIndex[%d]\n", outputBufferIndex);
            ...
            while (outputBufferIndex >= 0) {
                ...
                outputBuffer.clear();
                // 播放解码后的数据
                System.out.printf("[TUTK]start_ipcam_audio playAudioTrack stream info.size[%d]\n", info.size);
