package com.example.cameramulti.module.module.bean.audio;
...
public class AacEncode {
    ...
    public byte[] offerEncoder(byte[] input) throws Exception {
        ...
        while (outputBufferIndex >= 0) {
            ...
            // Log.d(BaseApplication.TAG,"AAC data only size is "+outBitsSize);
    ...
    private void addADTStoPacket(byte[] packet, int packetLen) {
        ...
        // Log.d(BaseApplication.TAG,"AAC data input adts paketLen is "+packetLen);
        int chanCfg = 2; // CPE
        packet[0] = (byte) 0xFF;
        packet[1] = (byte) 0xF9;
